"""
Django management command to add demo Nepali testimonials.
Usage: python manage.py add_nepali_testimonials
"""
...
class Command(BaseCommand):
    help = 'Add demo Nepali testimonials for Bhanjyang Cooperative'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('Adding demo Nepali testimonials...')
