...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='https://yourdomain.com,https://www.yourdomain.com').split(',')
...
try:
    ...
    # Fallback to SQLite if PostgreSQL config is not available
    DATABASES = {
        'default': {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=f"Bhanjyang Cooperative <{EMAIL_HOST_USER}>")
